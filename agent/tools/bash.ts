...
export default defineTool({
  description:
    ...
    "Используй для запуска команд: git, ls, uv, systemctl --user и т.д. " +
    "Не используй bash для напоминаний, nohup/sleep/curl-таймеров или других долгоживущих фоновых процессов; " +
    "для напоминаний есть инструмент reminders.",
