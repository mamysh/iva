...
| `iva doctor` | Checks Node ≥ 24, `.env` keys, build/runtime Workflow profile match, PostgreSQL schemas when active, units, both services, six timers (five memory + reminders), vault git origin — auto-repairs what's safe |
