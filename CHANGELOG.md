...
- 💬 **Reply больше не теряет сообщение** - ответ на сообщение Ивы запускает обычный ход, если Ива не ждёт ответа на вопрос; ожидаемый ответ по-прежнему продолжает прежний ход.
