...
**Исходное авторство.** Iva создал [Шима (`smixs`)](https://github.com/smixs) как [smixs/iva](https://github.com/smixs/iva). Этот репозиторий — production-продолжение исходного проекта для данного развёртывания.
